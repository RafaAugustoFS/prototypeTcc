...
/**
 * Repositório para a entidade {@link FeedBackByStudent}.
 * Esta interface estende {@link JpaRepository}, fornecendo métodos CRUD (Create, Read, Update, Delete)
 * e operações de paginação e ordenação para a entidade {@link FeedBackByStudent}.
 * Além disso, inclui um método personalizado para buscar feedbacks por ID do professor recipiente.
 *
 * @see JpaRepository
